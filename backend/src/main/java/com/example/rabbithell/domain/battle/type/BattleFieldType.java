...
public enum BattleFieldType {
	...
	DIM_CRACK(true, 5, 0, 0.02),
	TWILIGHT_CRACK(true, 50, 0, 0.8),
	ETHER_CRACK(true, 250, 0, 0.6),
	NEXUS_CRACK(true, 1000, 0, 0.4),
	DREAM_CRACK(true, 5000, 0, 0.2),
	CENTER_CRACK(true, 50000, 0, 0.01);
