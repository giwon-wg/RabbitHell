...
public enum DeckExceptionCode {
	...
	DECK_CACHE_MISS(false, HttpStatus.NOT_FOUND, "유저 클로버의 해당 덱 응답 dto들을 Redis에서 찾을 수 없습니다."),
	PAW_CARD_EFFECT_CACHE_MISS(false, HttpStatus.NOT_FOUND, "유저 클로버의 해당 paw-card-effect 응답 dto를 Redis에서 찾을 수 없습니다.");
